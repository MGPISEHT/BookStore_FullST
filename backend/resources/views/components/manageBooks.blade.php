<x-layout>
    ...
    @include('.components.Books.addBooks')
    @include('.components.Books.editBooks')
        ...
        <div class="table-data">
            <div class="d-flex justify-content-between align-items-center flex-wrap p-3">
                ...
                <div class="serach_field-area d-flex align-items-center justify-content-between">
                    <button class="btn btn-sm btn-success m-2" data-toggle="modal" data-target="#addBookModal">
                        Add Book
                    </button>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex">
                                ...
                                <a href="{{ route('books.edit', $book->id) }}" data-toggle="modal" data-target="#editBookModal{{ $book->id }}" class="btn btn-sm btn-primary m-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                        <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                        <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z" />
                                    </svg></a>

                                <button class="btn btn-sm btn-danger m-2" data-toggle="modal" data-target="#deleteBookModal{{ $book->id }}">
                        ...
                        @else
                        <tr>
                            <td colspan="9" class="text-center">There are no books available.</td>
                        </tr>
                        @endif
