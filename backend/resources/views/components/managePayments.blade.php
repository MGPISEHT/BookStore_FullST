<x-layout>
    ...
    @include('components.Payments.paymentAdd')
    @include('components.Payments.paymentEdit')
    @include('components.Payments.paymentDelete')
    <section class="main_content dashboard_part large_header_bg">
        ...
        <div class="table-data">
            ...
            <div class="container-fluid p-2">
                <table class="table p-4" id="paymentTable">
                    ...
                    <tbody>
                        ...
                        @else
                        <tr>
                            <td colspan="9" class="text-center">There are no payment records.</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
